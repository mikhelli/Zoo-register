...
> **Projeto Acadêmico:** Solução desenvolvida como resposta à atividade prática da disciplina de **Paradigmas de Programação**, com foco na aplicação e consolidação do **Paradigma Orientado a Objetos (POO)**.

---

##  Sobre o Projeto

O objetivo do sistema é gerenciar o cadastro e a visitação dos animais de um zoológico, aplicando conceitos cruciais da Orientação a Objetos como **polimorfismo**, **encapsulamento**, **abstração** e uso de **interfaces**. 
